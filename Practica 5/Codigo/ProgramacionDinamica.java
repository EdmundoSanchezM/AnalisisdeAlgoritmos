 ...
 * seleccionar cualquier nodo de un grafo dirigido con peso y dirigirnos a
 * cualquier otro nodo El programa esta basado en la progrmacion dinamica ya que
 * se descompone un problema en subproblemas
...
public class ProgramacionDinamica {
    ...
    * Busca el camino mas corto
    ...
    public static void main(String[] args) {
        ...
        FloydWarshall Objeto = new FloydWarshall(objetoN,numVertices,pesos);
