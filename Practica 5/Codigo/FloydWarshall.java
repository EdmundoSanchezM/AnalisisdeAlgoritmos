...
public class FloydWarshall {
    ...
    * @param dist arreglo de tamanio numVertices para guardar la distancia de
    * un nodo a otro
    * @param nodosVisit arreglo de tamanio numVertices para guardar los nodos 
    * visitados para llegar a un nodo determinado
    * @param InicioNodo nodo de inicio
    * @param FinNodo nodo fin
    * @param NombreEstados nombre de los estados ordenados ordenados de acuerdo
    * a los nodos
     */
    ...
    * @param rutasgt numero de ruta a analizar de un nodo
    ...
    /**Funcion para obtener el subproblema siguiente del problema inicial 
     * y se llama a minimo
    * @param nodosgt nodo del problema siguiente
    * @param nodoInicio nodo del problema inicial
     */
    ...
    * @param nodoInicio nodo del problema inicial
     ...
     *
     */
    public FloydWarshall(Nodos objeto, int numVertices, int[][] pesos) {
    ...
    /**Funcion para realizar el algoritmo de Floyd-Marshall
     * 
     */
    public void floydWarshall() {
        subpinicial(this.InicioNodo);
        printCamino(dist, nodosVisit);
    }

    /**Funcion para imprimir el camnio mas corto de los nodos seleccionados
     * @param grafo contiene las distancias correspondiente con el numero de 
     * arreglo donde se encuentra
     * @param rutas rutas mas corta por cada nodo hacia otros
     */
    public void printCamino(int[][] grafo, int[][] rutas) {
        ...
        String path = "";
        int bandera = 0;
        if (grafo[InicioNodo][FinNodo] != numVertices && FinNodo > InicioNodo) {
            bandera = 1;
